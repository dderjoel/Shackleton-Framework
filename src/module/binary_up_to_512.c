...
void binary_up_to_512_randomizeobject(object_binary_up_to_512_str *o) {
  ...
  BINARY_UP_TO_512_BINARY_MY_BINARY(o) =
      BINARY_UP_TO_512_BINARY_VALID_VALUES(o)[new_index1];
}
...
void binary_up_to_512_describeobject(char *desc,
                                     object_binary_up_to_512_str *o) {
...
void binary_up_to_512_writeobject(FILE *stream,
                                  object_binary_up_to_512_str *o) {
...
void *binary_up_to_512_copyobject(object_binary_up_to_512_str *o) {
  ...
  BINARY_UP_TO_512_BINARY_MY_BINARY_INDEX(c) =
      BINARY_UP_TO_512_BINARY_MY_BINARY_INDEX(o);
  BINARY_UP_TO_512_BINARY_MY_BINARY(c) = BINARY_UP_TO_512_BINARY_VALID_VALUES(
      c)[BINARY_UP_TO_512_BINARY_MY_BINARY_INDEX(o)];
