...
bool osaka_test_cycler(osaka_test_typ mode) {
  ...
  test[t++] = osaka_listlength(r0) == 0 && osaka_listlength(r1) == 1 &&
              osaka_listlength(r2) == 3 && osaka_listlength(r3) == 10;
  ...
  test[t++] = osaka_consistencycheck(r0) && osaka_consistencycheck(r1) &&
              osaka_consistencycheck(r2) && osaka_consistencycheck(r3);
  ...
  test[t++] = x0 == osaka_listlength(r0) && x1 == osaka_listlength(r1) &&
              x2 == osaka_listlength(r2) && x3 == osaka_listlength(r3);
  ...
  test[t++] = 0 == osaka_listlength(c0) && 1 == osaka_listlength(c1) &&
              3 == osaka_listlength(c2) && 10 == osaka_listlength(c3);
  ...
  test[t++] = c0 == NULL && c1 == NULL && c2 == NULL && c3 == NULL;
